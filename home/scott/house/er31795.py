...
def load():
    ...
    pine_door = doors_and_windows.Door('door', 'strong pine door', 'This is a strong pine door on the northwest side of the hallway.', 'domains.evergreen.mountaintop.cliff', 'northwest')
    pine_door.add_adjectives('pine')
    pine_door.move_to(entryway, True)

    stone_door = doors_and_windows.Door('door', 'stone door', 'This is a sturdy stone door on the southeast side of the hallway.', 'home.scott.house.descents', 'southeast')
