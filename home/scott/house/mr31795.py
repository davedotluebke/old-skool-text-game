...
def load():
    ...
    d = doors_and_windows.Door('door', 'strong osmium door', 'This door is made of pure osmium. It is on the west side of the room.', 'domains.school.school.water_kitchen', 'west')
