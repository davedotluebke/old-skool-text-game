...
feild.set_description('a field with a small shack on the west side', 'This feild is on the outskirts of Firlefile sorcery school and has a small shack on the west side.')
...
forest_two.add_exit('east', feild)
feild.add_exit('west', forest_two)
feild.add_exit('in', shack)
shack.add_exit('out', feild)
