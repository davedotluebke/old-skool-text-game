...
def load():
    ...
    female = mirror.Mirror('a female &s&u, smiling back at you', 'domains.character_creation.adjectives', gender="female")
    female.add_adjectives('north')
    r.insert(female)

    male = mirror.Mirror('a male &s&u, smiling back at you', 'domains.character_creation.adjectives', gender="male")
