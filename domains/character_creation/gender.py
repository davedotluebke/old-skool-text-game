...
def load():
    ...
    female = mirror.Mirror('a female &r&u, smiling back at you', 'domains.character_creation.adjectives', gender="female")
    female.add_adjectives('north')
    r.insert(female)

    male = mirror.Mirror('a male &r&u, smiling back at you', 'domains.character_creation.adjectives', gender="male")
