...
def load():
    ...
    human = mirror.Mirror('clear','a human, smiling back at you', 'domains.character_creation.gender', species='human')
    ...
    dwarf = mirror.Mirror('thick','a dwarf, smiling back at you', 'domains.character_creation.gender', species='dwarf')
    dwarf.add_adjectives('east', 'dwarf')
    r.insert(dwarf)

    gnome = mirror.Mirror('small','a gnome, smiling back at you', 'domains.character_creation.gender', species='gnome')
