...
def load():
    ...
    r.add_exit('west', 'domains.centrata.firefile_area.key_quest.treetop2', caution_tape_msg='The bridge to the west is surrounded by caution tape, and you decide not to test its strength.')
    return r
