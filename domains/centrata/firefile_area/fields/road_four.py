...
def load():
    ...
    road_four.add_exit('south', 'domains.centrata.firefile_area.fields.road_three')
    road_four.add_exit('north', 'domains.centrata.kings_road?domains.centrata.firefile_area.fields.road_four&domains.centrata.firefile_area.fields.road_four&20&0')
