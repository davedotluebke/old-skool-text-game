...
def load():
    ...
    road_four.add_exit('north', 'domains.centrata.kings_road?domains.centrata.firefile_area.fields.road_eight&domains.centrata.firefile_area.fields.road_four&20&0')
    return road_eight
