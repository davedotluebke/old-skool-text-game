...
def load():
    ...
    road_four.add_exit('north', 'domains.centrata.kings_road?domains.centrata.firefile_area.fields.road_eight&domains.centrata.firefile_area.village.south_village&20&0')
    road_eight.add_exit('north', 'domains.centrata.firefile_area.village.south_village')
    return road_eight
