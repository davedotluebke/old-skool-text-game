...
def load():
    ...
    street.add_exit('west', 'domains.centrata.firefile_area.village.village_fountain')
    street.add_exit('east', 'domains.centrata.firefile_area.village.east_village')
    street.add_exit('north', 'domains.centrata.firefile_area.village.armourer')
    street.add_exit('south', 'domains.centrata.firefile_area.village.fletchers_shop')
