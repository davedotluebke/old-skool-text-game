...
def load():
    ...
    r.add_exit('southeast', 'domains.centrata.key_quest.maze_entrance')
    r.add_exit('northwest', 'domains.centrata.key_quest.maze16')
    r.add_exit('west', 'domains.centrata.key_quest.maze49')
