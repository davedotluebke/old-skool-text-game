...
def load():
    ...
    intersection.add_exit('south', 'domains.centrata.village.street1')
    intersection.add_exit('north', 'domains.centrata.village.street2')
    intersection.add_exit('west', 'domains.centrata.village.street4')
    intersection.add_exit('east', 'domains.centrata.village.street3')
