...
def load():
    ...
    south_village.add_exit('south', 'domains.centrata.fields.road_eight')
    south_village.add_exit('north', 'domains.centrata.village.street1')
    south_village.add_exit('east', 'domains.centrata.village.blacksmith_shop')
