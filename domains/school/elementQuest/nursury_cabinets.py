...
def clone():
    ...
    nursury_cabinets.set_description('cabinets', 'These are some white painted wood cabinets. One of them has a painting of a mockingbird painted on it.', unlisted=True)
    ...
    baby_toy_3 = gametools.clone('domains.school.elementQuest.baby_toy_3')
