...
def load():
    ...
    dungeon_hall.set_description('dungeon hall', 'This is an old cave which has moss growing on its damp walls. It seems like it was made for a purpose. There are tunnels to the north, south and west; and a crawlway to the east.')
    ...
    dungeon_hall.add_adjectives('purposeful')
    return dungeon_hall
