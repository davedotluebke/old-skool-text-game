...
def load():
    ...
    small_tunnel.set_description('small tunnel', 'You are in a small tunnel which turns into a crawlway to the south. There is an exit off the tunnel to the west which has a yellow glow coming from the end. A dark tunnel leads north.')
