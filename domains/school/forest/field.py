...
def load():
    ...
    field.set_description('field with a small shack on the west side', 'This field is on the outskirts of Firlefile sorcery school and has a small shack on the northwest side.')
    field.add_exit('west', 'domains.school.forest.forest2')
    field.add_exit('northwest', 'domains.school.forest.shack')
