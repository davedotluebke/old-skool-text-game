...
def load():
    ...
    field.set_description('field with a small shack on the west side', 'This field is on the outskirts of Firefile sorcery school and has a small shack on the northwest side.')
