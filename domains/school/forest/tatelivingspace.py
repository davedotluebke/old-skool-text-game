...
def load():
    ...
    coach.add_adjectives('cozy', 'small')
    coach.add_response(['sit down'], 'you sit down, it is very comfy.', True, True)
    coach.add_response(['get up'], 'you get up.', emit_message='%s looks around the room.')
