...
def load():
    ...
    pine_two.add_response(['climb'], "Unfortunately, the lower branches are not as strong as the sturdy trunk, and you can't seem to get a hold of the higher ones.", emit_message='%s reaches for the lower branches, but they break off.')
