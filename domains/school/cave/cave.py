...
def load():
    ...
    cave.indoor = True
    cave.set_description('terrifying dark cave', 'This is one of the most scary caves you have ever been in. You are anxiously looking around to see if there are any monsters.')
