...
def load():
    ...
    fire_lounge.set_description('warm lounge', 'You find yourself in a warm room with red and orange painted stone walls and pictures of fires and volcanoes. Many comfortable chairs are in the room. A grand fireplace stands to the south.')
